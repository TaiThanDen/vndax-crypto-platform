...
import BlogCart from "@/components/Blog/BlogCart.tsx";
...
const BlogPage: React.FC<BlogPageProps> = ({
  ...
  const featuredBlogs = [
    ...
    },
    {
      ...
      subtitle:
        "Thế giới tiền mã hóa đã đi được một chặng đường dài trong bảy năm qua.",
      date: "2024-07-12",
  ...
  const blogs = [
    {
      ...
      date: "2025-04-01",
      description:
        "Live Trading trên VNDAX Square - Trải nghiệm Ngay Trong Các Buổi Livestream và Mua/Bán Cùng Với Các Chuyên Gia.",
    ...
    },
    {
      ...
      date: "2025-03-10",
      description:
        "Không chỉ là câu chuyện về pizza: Sức mạnh của tiền mã hóa trong thế giới thực tế.",
      image:
        "https://media.licdn.com/dms/image/v2/C4E1BAQEEtbEVtow0LQ/company-background_10000/company-background_10000/0/1648575083256/crypto_power_cover?e=2147483647&v=beta&t=2KlerXr80tMFbzrWp5yo-R0n3RHHSMb1ZhztS5GZbtM",
      category: "Thị trường",
    },
    {
      title: "Pizza Day",
      ...
      image:
        "https://images.ctfassets.net/hzjmpv1aaorq/3RTCLGRJFZgzy44YOIUGHK/c6eff0ea84bb0ea64b99a47cae2f5a63/Copy_of_Blog_Images_-_Skilling__47_.jpg?q=70",
      category: "Earn",
    },
    {
      ...
      date: "2025-03-14",
      description:
        "Hiểu rõ vai trò của chúng tôi trong không gian tiền mã hóa và cách chúng tôi bảo vệ tài sản của bạn.",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAh7x-SKSK_gw3UuzcgB75xMMvOtJuaLvF6g&s",
      category: "Từ CEO",
    },
    {
      ...
      description:
        "Thế giới tiền mã hóa đã đi được một chặng đường dài trong bảy năm qua.",
      image:
        "https://cdn2.fptshop.com.vn/unsafe/1920x0/filters:format(webp):quality(75)/nam_ca_nhan_so_7_nam_2025_thumbnail_2b665aa462.jpg",
      category: "Từ CEO",
    },
    {
      ...
      date: "2023-11-22",
      description:
        "Nguyễn Văn A  đã được bổ nhiệm làm CEO mới của VNDAX trong giai đoạn đầy thách thức.",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAh7x-SKSK_gw3UuzcgB75xMMvOtJuaLvF6g&s",
      category: "Lãnh đạo",
    },
    ...
    <div className="bg-background text-foreground">
      ...
      >
        {featuredBlogs.map((blog, index) => (
          ...
          >
            <Link to="/blog">
              <div className="relative h-[400px] sm:h-[450px] md:h-[500px] transition-transform hover:scale-[1.01] rounded-lg overflow-hidden cursor-pointer">
                <img
                  src={blog.image}
                  alt="Banner"
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent flex flex-col justify-end p-3 sm:p-6">
                  ...
                  <h2 className="text-white text-sm sm:text-lg md:text-xl font-bold line-clamp-2 hover:underline cursor-pointer">
                    {blog.title}
                  </h2>
                  {blog.subtitle && (
      ...
      <div
        ref={blogListRef}
        className="grid md:grid-cols-Responsive-md lg:grid-cols-Responsive-lg gap-5"
      >
        {filteredBlogs.map((blog, idx) => (
          <BlogCart key={idx} {...blog} />
        ))}
      </div>
    </div>
  );
