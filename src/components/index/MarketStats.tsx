    ...
    <section className="bg-[hsl(var(--background))] py-16" id="market">
      <div className="container-custom">
        ...
        >
          ...
          <div className="flex flex-col space-y-8  " data-aos="fade-up">
            <Link to="/market">
              <div className="bg-[hsl(var(--background))] shadow-md hover:hover:shadow-[0_4px_20px_rgba(34,197,94,0.5)] transition-colors transition-shadow duration-300 rounded-lg p-6 flex items-center gap-4">
                ...
                <div>
                  <div className="text-xl text-[hsl(var(--muted-foreground))] mb-1">
                    {t("assetTitle")}
                  </div>
          ...
          <div
            className="bg-[hsl(var(--background))] shadow-md hover:hover:shadow-[0_4px_20px_rgba(34,197,94,0.5)] transition-colors duration-300 rounded-lg overflow-hidden"
            data-aos="fade-up"
          >
            <div className="flex justify-between items-center p-4 border-b border-[hsl(var(--muted-foreground))]/40">
              <div className="text-xl font-medium text-[hsl(var(--foreground))]">
                {t("topTradesTitle")}
              </div>
              <Link to="/market">
                <Button
              ...
              <table className="w-full">
                <thead className="text-[hsl(var(--muted-foreground))] text-sm">
                  <tr className="border-b border-[hsl(var(--muted-foreground))]/30">
                    ...
                    <th className="py-3 px-4 hidden sm:flex text-right">
                      {t("tradeTableTrade")}
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {markets.map((market, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-right text-[hsl(var(--foreground))]">
                        {market.price}
                      </td>
                      <td
                        ...
                        <Link to="/trade_spot">
                          <div className="hidden sm:flex justify-end gap-1">
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-7 text-xs bg-green-500/10 text-green-500 hover:text-white hover:bg-green-500/80"
                            >
                              {t("tradeTableBuy")}
                            </Button>
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-7 text-xs bg-red-500/10 text-red-500 hover:text-white hover:bg-red-500/80"
                            >
                              {t("tradeTableSell")}
                            </Button>
                          </div>
