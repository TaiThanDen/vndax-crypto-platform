...
const Footer = () => {
  return (
    <footer className="bg-vndax-black pt-16 pb-8" id="support">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Nền tảng giao dịch tài sản số hàng đầu Việt Nam với trải nghiệm người dùng đơn giản và bảo mật tối đa.
            </p>
          ...
          {/* Column 2: Products */}
          <div>
            <h3 className="text-white font-semibold text-lg mb-5">Sản phẩm</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-vndax-green transition-colors">Trung tâm trợ giúp</a></li>
              <li><a href="#" className="text-gray-400 hover:text-vndax-green transition-colors">Hướng dẫn người mới</a></li>
          ...
          {/* Column 4: Policies */}
          <div>
            <h3 className="text-white font-semibold text-lg mb-5">Chính sách</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-vndax-green transition-colors">Điều khoản dịch vụ</a></li>
              <li><a href="#" className="text-gray-400 hover:text-vndax-green transition-colors">Chính sách bảo mật</a></li>
              <li><a href="#" className="text-gray-400 hover:text-vndax-green transition-colors">Chính sách KYC & AML</a></li>
              <li><a href="#" className="text-gray-400 hover:text-vndax-green transition-colors">Báo cáo lỗ hổng</a></li>
        ...
        <div className="border-t border-vndax-lightgray pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2025 VNDAX. Đã đăng ký Bản quyền.
          </p>
          <div className="flex space-x-6">
            ...
            <a href="#" className="text-gray-400 hover:text-vndax-green transition-colors text-sm">Nghề nghiệp</a>
          </div>
        </div>
      </div>
