...
export const BlogPage: React.FC<BlogPageProps> = ({
  ...
  const featuredBlogs = [
    {
      ...
      date: "2025-02-25",
      image:
        "https://t4.ftcdn.net/jpg/05/85/86/37/360_F_585863704_PxickM4FdnP9Rl6Am0AGy8E7CtjkFg19.jpg",
    },
    {
  ...
  const blogs = [
    ...
    },
    {
      ...
      image: "/images/what-VnDax-is.jpg",
      category: "Từ CEO",
    },
    {
    ...
    {
      title: "Tiểu sử: Richard Teng – CEO mới của VnDax",
      date: "2023-11-22",
      description:
        "Richard Teng đã được bổ nhiệm làm CEO mới của VnDax trong giai đoạn đầy thách thức.",
    ...
    <div className="bg-background text-foreground">
      ...
      >
        {filteredBlogs.map((blog, idx) => (
          <BlogCard key={idx} {...blog} onBlogClick={() => onBlogClick(blog)} />
        ))}
      </div>
    </div>
  );
